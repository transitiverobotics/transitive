...
apt-key --keyring $DIR/etc/apt/trusted.gpg.d/ros.gpg adv --keyserver 'hkp://keyserver.ubuntu.com:80' --recv-key C1CF6E31E6BADE8868B172B4F42ED6FBAB17C654
